  ...
  return (
    <div className="h-24 absolute bottom-0 w-full">
      <form className="h-full flex items-center px-4" onSubmit={onSubmitChat}>
        <input
          className={`grow py-1 px-2 focus:outline-none border-2 focus:border-blue-400 mr-4 ${
        ...
        />
        <button
          className="w-28 py-[6px] text-sm bg-blue-400 hover:bg-blue-600 active:bg-blue-400 rounded-lg text-white font-semibold flex justify-center"
          type="submit"
          disabled={isLoading}
        >
          {isLoading ? (
